# RailsAdmin config file. Generated on March 04, 2013 09:49
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Memoly', 'Admin']
  ...
  # config.excluded_models = ['AlphaUser', 'Comment', 'Group', 'Memoid', 'Post', 'TurboMemoid', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['AlphaUser', 'Comment', 'Group', 'Memoid', 'Post', 'TurboMemoid', 'User']
  ...
  # config.model 'AlphaUser' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your alpha_user.rb model definition
  ...
  # config.model 'Memoid' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your memoid.rb model definition
  ...
  # config.model 'TurboMemoid' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your turbo_memoid.rb model definition
  ...
  #     configure :memoids, :has_many_association 
